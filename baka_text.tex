...
Dalším způsobem, jak změřit chybovost, s jakou uživatel text zadal, je vyhodnocení Levenshteinovy vzdálenosti originálního a přepsaného řetězce, tedy nejmenšího počtu editací výsledného řetězce, kterými jej lze převést do podoby originálního řetězce. K dispozici jsou operace smazání znaku, vložení znaku a náhrady znaku jednoho za jiný. % cit https://en.wikipedia.org/wiki/Levenshtein_distance & gradu04481.pdf ch 1.1.4
...
\section{Historie predikce textu}
